...
class EGraph2dGridHeuristic : public EGraphHeuristic<std::vector<int> >{
  public:
    EGraph2dGridHeuristic(const EGraphable<std::vector<int> >& env, int size_x, int size_y, int move_cost);
  ...
  protected:
    ...
    std::vector<EGraph2dGridHeuristicCell> heur;
    std::vector<EGraph2dGridHeuristicCell> sc;
